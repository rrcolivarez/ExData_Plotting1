...
Global_reactive_power <- as.numeric(subpower_table$Global_reactive_power)
Voltage <- as.numeric(subpower_table$Voltage)
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lwd=2, col=c("black", "red", "blue"), box.lwd = 0)
